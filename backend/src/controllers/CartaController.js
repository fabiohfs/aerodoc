...
module.exports = {
    async getChart(req, res) {
        ...
        await axios.get(url, {
            ...
            //TODO: Verificar como será tratado para o front
            const filePath = path.resolve(__dirname, '/Users/fabio/Documents/', tipo + ' - ' + icao + '.pdf')
            ...
            return res.send({ "message": "file downloaded" })
        })
